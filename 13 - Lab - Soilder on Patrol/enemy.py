...
class Enemy(object):
    ...
    def __init__(self, world=None, scale=10.0, mass=1.0, mode='seek'):
        ...
        self.max_speed = 7.0 * scale
        self.max_force = 500.0

        self.hp = 5
        self.target = self.world.agents[0].pos
    ...
    def calculate(self, delta):
        ...
        if mode == 'seek':
            ...
            force = self.arrive(self.target, 'slow')
        elif mode == 'arrive_normal':
            force = self.arrive(self.target, 'normal')
        elif mode == 'arrive_fast':
            force = self.arrive(self.target, 'fast')
        elif mode == 'flee':
            force = self.flee(self.target)
        elif mode == 'pursuit':
