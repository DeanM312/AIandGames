...
class World(object):
    ...
    def __init__(self, cx, cy):
        ...
        self.patrolpath.add_way_pt(p1)
        self.patrolpath.add_way_pt(p2)
        self.patrolpath.add_way_pt(p3)
        self.patrolpath.add_way_pt(p4)
        self.patrolpath.add_way_pt(p4)
    ...
    def render(self):
        ...
        if self.show_info:
            #infotext = ', '.join(set(agent.state for agent in self.agents))
            agent = self.agents[0]
            infotext = "State: " + agent.state + " Sub State: " + agent.secondstate
            egi.white_pen()
