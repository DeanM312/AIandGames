    ...
    def add_handers(self):
        ...
        def on_mouse_press(x, y, button, modifiers):
            if button == 1: # left
                ...
                if self.agent_type == 'slow':
                    self.world.agents.append(Agent(self.world,'slow',x,y))
                elif self.agent_type == 'fast':
                    self.world.agents.append(Agent(self.world,'fast',x,y))
